...
global.owner = process.env.OWNER_NUMBER  || '94702164360' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=3IUAxZKA#ddLdzlaiqGYgdTTg0mVOcmef8Ajj2jHAz_7WOuMtmtQ' ,
